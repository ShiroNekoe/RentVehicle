    ...
    public function createPayment(Request $request)
{
    ...
    try {
        ...
        $payment = Payment::create([
            ...
            'payment_status' => 'pending', // default status saat ini
            'payment_date' => now(),
        ...
        return response()->json([
            'status' => true,
            'message' => 'Pembayaran dibuat, status ' . $payment->payment_status,
            'payment_status' => $payment->payment_status,  // Kirim status pembayaran
            'data' => $payment,
            'debug' => $debugInfo,
        ]);
    } catch (\Exception $e) {
