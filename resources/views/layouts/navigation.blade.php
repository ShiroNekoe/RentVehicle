    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            ...
            @guest
                ...
                <a href="#" class="block text-white py-2 px-3">Service</a>
                <a href="#" class="block text-white py-2 px-3">Top Rated</a>
                <a href="#" class="block text-white py-2 px-3">Experience</a>
            ...
            @else
                ...
                <form method="POST" action="{{ route('logout') }}">
                    @csrf
                    <a href="{{ route('logout') }}" onclick="event.preventDefault(); this.closest('form').submit();" class="block text-white py-2 px-3">{{ __('Log Out') }}</a>
                </form>
            @endguest
        </div>
    </div>
