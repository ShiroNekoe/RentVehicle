        ...
        <div class="hero min-h-[70vh] bg-cover bg-center">
            <div class="hero-content flex-col lg:flex-row-reverse z-10 px-6 w-full space-y-6 lg:space-y-0 lg:space-x-6">
                ...
                <div class="w-full lg:w-1/2 flex justify-end mt-20" data-aos="fade-right" data-aos-duration="1000">
                    <img src="{{ asset('img/hero-car.png') }}" class="max-w-full lg:max-w-full max-h-[80vh] object-contain rounded-lg drop-shadow-xl" alt="Hero Car" />
                </div>
...
<footer class="bg-[#2C3E50] py-12 text-white font-sans">
  <div class="max-w-7xl mx-auto px-6 grid grid-cols-1 md:grid-cols-3 gap-8 items-center">

    <!-- Deskripsi -->
    <div class="max-w-md">
      <p class="text-lg font-medium tracking-wide leading-relaxed mb-2">
        The best car & motorbike rental service
      </p>
      <p class="text-2xl lg:text-3xl font-extrabold tracking-wide">
  ...
  <!-- Bottom line -->
  <div class="border-t border-gray-600 mt-10 pt-6 text-center text-white text-sm select-none">
